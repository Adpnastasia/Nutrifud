...
const serviceAccount = require('serviceaccount.json'); // Replace with your serviceAccountKey.json

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: 'https://nutrifud-e9af4-default-rtdb.firebaseio.com', // Replace with your Firebase project URL
});

const firestore = admin.firestore();

// Replace 'reviews' with the name of your collection
...
const importRecipes = async () => {
  try {
    for (const recipe of recipes) {
      ...
      await firestore.collection(collectionName).add(recipe);
